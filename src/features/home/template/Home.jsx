...
import { Text, TouchableOpacity, View, Image, Modal, FlatList, Pressable } from "react-native";
    ...
    <View style={generalStyles.container}>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity onPress={()=>navigation.navigate('NotificationMainView')}>
            <Icon
              name="bell"
              size={20} // Kích thước icon
              color="white" // Màu sắc icon
              style={{ marginLeft: 8 }} // Khoảng cách giữa text và icon
            />
          </TouchableOpacity>
        </View>
      </View>
      ...
      {/* Thông tin chung */}
      <InfoSection
        style={{ position: "absolute", zIndex: 10, top: "8%" }}
        data={infoData}
        numColumns={2}
      />
      ...
      <View
        style={[
          homeStyles.containerColumn,
          { gap: 40, position: "absolute", top: "28%" },
        ]}
      >
