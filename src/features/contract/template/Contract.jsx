...
const Contract = ({ navigation }) => {
  ...
  return (
    <View style={[generalStyles.container, { backgroundColor: "white" }]}>
      <Header
        leftIcon={
          <Icon onPress={() => navigation.goBack()} name="chevron-left" size={20} />
        }
      ...
      <ScrollView contentContainerStyle={{ flex: 1 }}>
        <View style={{ flex: 1, paddingHorizontal: 20 }}>
          ...
          >
            {/* Contract Name */}
            <View style={{ flexDirection: "row", gap: 10, width: "100%", justifyContent: "center", marginBottom:10 }}>
              <Text style={{ fontWeight: "500", color: colors.primary_green, fontSize: 15 }}>
            ...
            <View style={{ flexDirection: "row", gap: 10 }}>
              ...
              <Text style={{ fontWeight: "500", color: colors.gray59 }}>
                Thời hạn: {`${convertDate(contract?.start_day)} đến ${convertDate(contract?.end_day)}`}
              </Text>
            </View>
            ...
            <View style={{ flexDirection: "row", gap: 10 }}>
              ...
              <Text style={{ fontWeight: "500", color: colors.gray59 }}>
                Thanh toán: {contract?.payment_term === 0 ? "Chuyển khoản" : "Tiền mặt"}
              </Text>
            </View>
